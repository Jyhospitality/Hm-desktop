...
$to = 'hospitalityminds.bd@gmail.com'; //<-----Put Your email address here.
$name = $email = $phone = "";
...
if (!empty($_POST['name']) && !empty($_POST['email'])) {
    ...
    echo "Thanks for showing your Interest in our services. We will get back to you shortly. You can call us at +91 9967333442";
} else {
